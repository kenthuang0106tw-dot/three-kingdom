...
test("rejected Task 10.5P keeps production frozen and selects only Task 10.5D", async () => {
  ...
  assert.match(roadmap, /\*\*Next:\*\* M10 \/ Task 10\.5D — Zhang Fei Second-Player Direction Decision/);
});
