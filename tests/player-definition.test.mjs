...
test("Player composition consumes one definition without adding Zhang Fei runtime", async () => {
  ...
  assert.match(scene, /private readonly playerDefinition = GUANYU_PLAYER_DEFINITION/);
